...
@implementation Graph2ViewControler
...
{   
    ...
    self.scatterPlot1= [[CustomPlot2 alloc] initWithHostingView:_graphHostingView andData:data andXax:xax andYax :yax andGraphtype:self.graphtype];
    // self.scatterPlot1.delegate=self;
    self.scatterPlot1.xax=xax;
    self.scatterPlot1.yax=yax;
    
	UIDeviceOrientation orientation = [[UIDevice currentDevice] orientation];
    [self.scatterPlot1 initialisePlot];
	...
	{
        NSLog(@"orientation is UIDeviceOrientationPortrait");
	}
    // [self viewDidLoad];
